...
Chaque élément ``<div>`` utilisé dans la ``<strucMap>`` peut être décrit dans une ``<dmdSec>`` en MODS ([http://www.loc.gov/standards/mods](http://www.loc.gov/standards/mods)).
...
*Remarque :* une sous-partie peut posséder sa propre introduction (voir à ce propos [la documentation MODS spécifique de OpenEdition Journals](https://github.com/OpenEdition/mets.openedition/wiki/3.-Documentation-MODS-pour-OpenEdition-Journals)).
